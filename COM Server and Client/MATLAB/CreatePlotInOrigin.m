...
function CreatePlotInOrigin()   
    ...
    originObj.Execute('syspath$=system.path.program$;');
    strPath='';
    strPath = invoke(originObj, 'LTStr', 'syspath$');
    originObj.Load(strcat(strPath, 'Samples\COM Server and Client\Matlab\CreatePlotInOrigin.OPJ'));
    ...
    originObj.PutWorksheet('Data1', mdata);
